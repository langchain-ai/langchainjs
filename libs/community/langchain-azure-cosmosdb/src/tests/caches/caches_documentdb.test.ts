...
import { AzureDocumentDBSemanticCache } from "../../index.js";
...
describe("AzureDocumentDBSemanticCache", () => {
  it("should store, retrieve, and clear cache in Azure DocumentDB", async () => {
    const mockClient = createMockClient() as any;
    const embeddings = new FakeEmbeddings();
    const cache = new AzureDocumentDBSemanticCache(
      embeddings,
      {
