...
test("AzureDocumentDBVectorStore works", async () => {
  const client = createMockClient();
  const embeddings = new FakeEmbeddings();
  const store = new AzureDocumentDBVectorStore(embeddings, {
...
test("AzureDocumentDBVectorStore manages its index", async () => {
  const client = createMockClient();
  const embeddings = new FakeEmbeddings();
  const store = new AzureDocumentDBVectorStore(embeddings, {
    client: client as any,
...
test("AzureDocumentDBVectorStore deletes documents", async () => {
  const client = createMockClient();
  const embeddings = new FakeEmbeddings();
  const store = new AzureDocumentDBVectorStore(embeddings, {
    client: client as any,
...
test("AzureDocumentDBVectorStore adds vectors", async () => {
  const client = createMockClient();
  const embeddings = new FakeEmbeddings();
  const store = new AzureDocumentDBVectorStore(embeddings, {
    client: client as any,
...
test("AzureDocumentDBVectorStore initializes from texts", async () => {
  const client = createMockClient();
  const embeddings = new FakeEmbeddings();
  const store = await AzureDocumentDBVectorStore.fromTexts(
    ["test", "hello", "world"],
    {},
    embeddings,
    { client: client as any }
...
test("AzureDocumentDBVectorStore initializes from documents", async () => {
  const client = createMockClient();
  const embeddings = new FakeEmbeddings();
