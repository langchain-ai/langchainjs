...
import { SIDEBAR_LABEL_PLACEHOLDER, MODULE_NAME_PLACEHOLDER, PACKAGE_NAME_PLACEHOLDER, FULL_IMPORT_PATH_PLACEHOLDER, ENV_VAR_NAME_PLACEHOLDER, PYTHON_DOC_URL_PLACEHOLDER, API_REF_MODULE_PLACEHOLDER, API_REF_PACKAGE_PLACEHOLDER, LOCAL_PLACEHOLDER, SERIALIZABLE_PLACEHOLDER, PY_SUPPORT_PLACEHOLDER } from "../constants.js";
