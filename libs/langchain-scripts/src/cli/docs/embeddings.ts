...
import { PACKAGE_NAME_PLACEHOLDER, MODULE_NAME_PLACEHOLDER, SIDEBAR_LABEL_PLACEHOLDER, FULL_IMPORT_PATH_PLACEHOLDER, LOCAL_PLACEHOLDER, PY_SUPPORT_PLACEHOLDER, ENV_VAR_NAME_PLACEHOLDER, API_REF_MODULE_PLACEHOLDER, API_REF_PACKAGE_PLACEHOLDER, PYTHON_DOC_URL_PLACEHOLDER } from "../constants.js";
