...
export namespace OpenRouter {
  ...
  export interface ChatMessageContentItemImage {
    image_url: { detail?: "auto" | "low" | "high" | (string & {}); url: string };
    type: string;
  }
  ...
  export interface ToolDefinitionJson {
    function: { description?: string; name: string; parameters?: Record<string, unknown>; strict?: boolean | null };
    type: string;
  }
  ...
  export interface ChatGenerationParams {
    ...
    provider?: __schema0;
    reasoning?: { effort?: "xhigh" | "high" | "medium" | "low" | "minimal" | "none" | (string & {}) | null; summary?: ReasoningSummaryVerbosity | null };
    response_format?: { type: string } | { type: string } | ResponseFormatJSONSchema | ResponseFormatTextGrammar | { type: string };
  ...
  export interface ProviderPreferences {
     ...
     */
    max_price?: { audio?: BigNumberUnion & unknown; completion?: BigNumberUnion & unknown; image?: BigNumberUnion & unknown; prompt?: BigNumberUnion; request?: BigNumberUnion & unknown };
    ...
    sort?: ProviderSort & ProviderSort | ProviderSortConfig | unknown;
  ...
  export interface ChatGenerationTokenUsage {
    ...
    completion_tokens_details?: { accepted_prediction_tokens?: number | null; audio_tokens?: number | null; reasoning_tokens?: number | null; rejected_prediction_tokens?: number | null } | null;
    prompt_tokens: number;
    prompt_tokens_details?: { audio_tokens?: number; cache_write_tokens?: number; cached_tokens?: number; video_tokens?: number } | null;
    total_tokens: number;
  }
  ...
  export interface ChatMessageTokenLogprob {
    ...
    logprob: number;
    token: string;
    top_logprobs: Array<{ bytes: Array<number> | null; logprob: number; token: string }>;
  }
  ...
  export interface ChatStreamingResponseChunk {
    data: { choices: Array<ChatStreamingChoice>; created: number; error?: { code: number; message: string }; id: string; model: string; object: string; system_fingerprint?: string | null; usage?: ChatGenerationTokenUsage };
  }

  export interface ChatError {
    error: { code: string | number | null; message: string; param?: string | null; type?: string | null };
  }

  export type __schema17 = Array<{ allowed_models?: Array<string>; enabled?: boolean; id: string } | { id: string } | { enabled?: boolean; engine?: "native" | "exa" | (string & {}); id: string; max_results?: number; search_prompt?: string } | { enabled?: boolean; id: string; pdf?: { engine?: "mistral-ocr" | "pdf-text" | "native" | (string & {}) } } | { enabled?: boolean; id: string }>;
  ...
  export type __schema0 = { allow_fallbacks?: __schema1; data_collection?: __schema3; enforce_distillable_text?: boolean | null; ignore?: __schema4; max_price?: __schema10; only?: __schema4; order?: __schema4; preferred_max_latency?: __schema15; preferred_min_throughput?: __schema15; quantizations?: __schema8; require_parameters?: __schema1; sort?: __schema9; zdr?: boolean | null } | null;
  ...
  export type __schema21 = "unknown" | "openai-responses-v1" | "azure-openai-responses-v1" | "xai-responses-v1" | "anthropic-claude-v1" | "google-gemini-v1" | (string & {}) | null;

  export type __schema3 = "deny" | "allow" | (string & {}) | null;

  export type __schema4 = __schema5 | null;

  export type __schema15 = number | { p50?: number | null; p75?: number | null; p90?: number | null; p99?: number | null } | null;
  ...
  export type __schema8 = Array<"int4" | "int8" | "fp4" | "fp6" | "fp8" | "fp16" | "bf16" | "fp32" | "unknown" | (string & {})> | null;
  ...
  export type __schema5 = Array<"AI21" | "AionLabs" | "Alibaba" | "Ambient" | "Amazon Bedrock" | "Amazon Nova" | "Anthropic" | "Arcee AI" | "AtlasCloud" | "Avian" | "Azure" | "BaseTen" | "BytePlus" | "Black Forest Labs" | "Cerebras" | "Chutes" | "Cirrascale" | "Clarifai" | "Cloudflare" | "Cohere" | "Crusoe" | "DeepInfra" | "DeepSeek" | "Featherless" | "Fireworks" | "Friendli" | "GMICloud" | "Google" | "Google AI Studio" | "Groq" | "Hyperbolic" | "Inception" | "Inceptron" | "InferenceNet" | "Infermatic" | "Inflection" | "Liquid" | "Mara" | "Mancer 2" | "Minimax" | "ModelRun" | "Mistral" | "Modular" | "Moonshot AI" | "Morph" | "NCompass" | "Nebius" | "NextBit" | "Novita" | "Nvidia" | "OpenAI" | "OpenInference" | "Parasail" | "Perplexity" | "Phala" | "Relace" | "SambaNova" | "Seed" | "SiliconFlow" | "Sourceful" | "StepFun" | "Stealth" | "StreamLake" | "Switchpoint" | "Together" | "Upstage" | "Venice" | "WandB" | "Xiaomi" | "xAI" | "Z.AI" | "FakeProvider" | (string & {}) | string>;
