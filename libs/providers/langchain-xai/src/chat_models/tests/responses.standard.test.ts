...
class ChatXAIResponsesStandardUnitTests extends ChatModelUnitTests<
...
const testClass = new ChatXAIResponsesStandardUnitTests();
testClass.runTests("ChatXAIResponsesStandardUnitTests");
