 ...
 * };
 *
 * const aiMessage = convertGenerateContentResponseToAIMessage(candidate);
 ...
 */
export const convertGenerateContentResponseToAIMessage: Converter<
  GeminiCandidate,
  AIMessage
> = (candidate) => {
