...
/**
 * skipped temporarily because of langsmith issues
 * @todo(@christian-bromann): fix before alpha release
 */
describe.skip("LangSmith interop", () => {
  beforeEach(() => {
  ...
  test.each(["true", "false"])(
    ...
    async (value) => {
      ...
      const root = RunnableLambda.from(async function* (
