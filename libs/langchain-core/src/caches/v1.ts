...
export function deserializeMessage(_storedMessage: StoredMessage): Message {
  throw new Error("Not implemented");
}

export function serializeMessage(_message: Message): StoredMessage {
  throw new Error("Not implemented");
}
 ...
 */
export abstract class BaseCacheV1<T = Message[]> {
 ...
 */
export class InMemoryCacheV1<T = Message[]> extends BaseCacheV1<T> {
   ...
   */
  static global(): InMemoryCacheV1 {
    return new InMemoryCacheV1(GLOBAL_MAP);
  }
}
