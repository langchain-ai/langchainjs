...
import { MilvusVectorStore } from "../vectorstores.js";
...
Harmonic Labyrinth of the dreaded Majotaur?`,
  ...
  const milvus = await MilvusVectorStore.fromTexts(
    texts,
    metadatas,
    embeddings,
    {
...
test.skip("Test Milvus.fromExistingCollection", async () => {
  const milvus = await MilvusVectorStore.fromExistingCollection(embeddings, {
    collectionName,
    autoId: false,
    primaryField: "id",
    clientConfig: {
