 ...
 */
function scanForSecrets(packagePath: string, excludePatterns: string[]): SecretInfo[] {
  ...
  const filesToScan = tsConfig.fileNames.filter((fileName) =>
 ...
 */
function scanSourceFile(sourceFile: ts.SourceFile, fileName: string, secrets: SecretInfo[]) {
 ...
 */
function generateSecretMap(packagePath: string, secrets: SecretInfo[], outputPath: string) {
