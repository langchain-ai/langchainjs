...
- [`BaseChatMessage`](BaseChatMessage.md).**AIChatMessage**

## Constructors

### constructor()

> **new AIChatMessage**(`text`: `string`): [`AIChatMessage`](AIChatMessage.md)
...
[langchain/src/schema/index.ts:74](https://github.com/hwchase17/langchainjs/blob/ddf2996/langchain/src/schema/index.ts#L74)
