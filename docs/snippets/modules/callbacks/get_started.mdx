...
The `callbacks` argument is available on most objects throughout the API ([Chains](../../modules/chains/), [Language Models](../../modules/model_io/models/), [Tools](../../modules/agents/tools/), [Agents](../../modules/agents/), etc.) in two different places.
