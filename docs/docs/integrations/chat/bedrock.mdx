...
Currently, only Anthropic models are supported with the chat model integration. For foundation models from AI21 and Amazon, see [the text generation Bedrock variant](/docs/integrations/llms/bedrock).
