...
- [`SearchApi`][SearchApi] - A wrapper around the Search API. This tool is handy when you need to answer questions about current events. Input should be a search query.
...
[SearchApi]: /docs/api/tools/classes/SearchApi
