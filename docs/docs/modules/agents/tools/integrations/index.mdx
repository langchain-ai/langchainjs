...
- [`AWSSfn`][AWSSfn] - A wrapper around the AWS Step Functions API, invoked via the Amazon Web Services Node.js SDK. Useful for orchestrating asynchronous workflows using serverless services based on state machines and tasks. 
...
[StartExecutionAWSSfnTool]: /docs/api/tools/classes/StartExecutionAWSSfnTool
[DescribeExecutionAWSSfnTool]: /docs/api/tools/classes/DescribeExecutionAWSSfnTool
[SendTaskSuccessAWSSfnTool]: /docs/api/tools/classes/SendTaskSuccessAWSSfnTool
