...
- [`HumanTool`][HumanTool] - Useful for when you need to ask the human to help out AI agent when it is confused. Input should be a question for the human.
...
[HumanTool]: /docs/api/tools/classes/HumanTool
