...
AI: {output}`);
const exampleChatPrompt = ChatPromptTemplate.fromMessages([
  ["human", "{input}"],
  ["ai", "{output}"],
]);
...
Chat Few Shot:  [
  HumanMessage {
    lc_namespace: [ 'langchain', 'schema' ],
    content: 'Could the members of The Police perform lawful arrests?',
    additional_kwargs: {}
  },
  AIMessage {
    lc_namespace: [ 'langchain', 'schema' ],
    content: 'what can the members of The Police do?',
    additional_kwargs: {}
  },
  HumanMessage {
    lc_namespace: [ 'langchain', 'schema' ],
  ...
  AIMessage {
    lc_namespace: [ 'langchain', 'schema' ],
    content: "what is Jan Sindel's personal history?",
    additional_kwargs: {}
  }
]
 */
