...
import JSONFunctions from "@examples/prompts/structured_parser_sequence.ts";

The JSON Functions Output Parser is a powerful tool for parsing structured JSON function responses, such as those from [OpenAI functions](/docs/modules/model_io/models/chat/how_to/function_calling). This parser is particularly useful when you need to extract specific information from complex JSON responses.
