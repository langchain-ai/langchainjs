...
This document loader is able to take full Notion pages and databases and turn them into a LangChain Documents ready to be integrated into your project.

## Setup

1. You will first need to install the official Notion client.
...
> The 32 char hex in the url path represents the `ID`.  
