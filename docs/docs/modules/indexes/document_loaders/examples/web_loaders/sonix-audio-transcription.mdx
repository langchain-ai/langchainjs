...
In the request you can transcribe either local file using audioFilePath or remote file using audioUrl parameter of the request.
You have to specify the audio language. See the list of supported languages [here](https://sonix.ai/docs/api#languages).

import CodeBlock from "@theme/CodeBlock";
import Example from "@examples/document_loaders/sonix-audio-transcription.ts";
