...
A Contextual Compression Retriever is designed to improve the answers returned from vector store document searches by better taking into account the context from the query.
