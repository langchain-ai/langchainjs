...
LangChain.js accepts [mysql Pool](https://medium.com/dscjssstu/pooling-connections-in-node-js-mysql-9685d5c03c30) as the connections pool for SingleStore vectorstore.
