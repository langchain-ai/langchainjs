...
**Note:** If you've previously been using `SupabaseVectorStore`, you may need to create a separate Postgres function with a different name and an additional `filter jsonb DEFAULT '{}'` parameter to use this functionality.
