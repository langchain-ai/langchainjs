...
- If you're in search of a vector database that you can load from both the browser and server side, check out [CloseVector](./integrations/closevector). It's a vector database that aims to be cross-platform.
