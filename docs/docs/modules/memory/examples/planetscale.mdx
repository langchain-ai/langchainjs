...
You will also need an Planeetscale Account and a database to connect to. See instructions on [Planetscale Docs](https://planetscale.com/docs) on how to create a HTTP client.
