...
import AdvancedExample from "@examples/models/llm/llm_quick_start.ts";
...
Here's a more advanced example with additional parameters, including the magical `-1` value for `max_tokens`:
