...
Currently (as of April 26th, 2023), the Unstructured API does not require an API key. The API
will begin to require an API key in the near future. The [Unstructured documentation page](https://unstructured-io.github.io/unstructured/)
will include instructions on how to obtain an API key once they are available.
