...
One of the most foundational Experession Language compositions is taking:
...
The below scrim from [Scrimba](https://scrimba.com) interactively walks through a simple prompt template + LLM chain.
