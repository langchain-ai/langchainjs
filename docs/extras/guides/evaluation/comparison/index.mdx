...
To create a custom comparison evaluator, inherit from the `PairwiseStringEvaluator` or `LLMPairwiseStringEvaluator` class and overwrite the `_evaluateStringPairs` method.
