...
LangChainJS provides the `MakerSuiteHub` class which lets you pull this prompt
...
either the Google PaLM [text](../../modules/model_io/models/llms/integrations/google_palm)
or [chat](../../modules/model_io/models/chat/integrations/google_palm) model:
...
import { MakerSuiteHub } from "langchain/experimental/hubs/makersuite/googlemakersuite";
