...
This is what the resulting trace looks like - note that the LLM tries twice before correctly choosing a matching enum:

https://smith.langchain.com/public/700f28f7-a6af-4ff5-a365-1a6dc55fc363/r
