...
```bash npm2yarn
npm install @aws-crypto/sha256-js @aws-sdk/credential-provider-node @aws-sdk/protocol-http @aws-sdk/signature-v4 @aws-sdk/eventstream-marshaller @aws-sdk/util-utf8-universal
```

## Usage

import CodeBlock from "@theme/CodeBlock";
import BedrockExample from "@examples/models/llm/bedrock-chat.ts";

<CodeBlock language="typescript">{BedrockChatExample}</CodeBlock>