...
# With glyph
> This feature can help users force the model to return content in the configured fixed format.
...
> This feature currently supports calling a search engine integrated by us to generate content,
> providing content retrieved by network engine, and assisting the big model to generate results.
