...
Here's an example worker that uses Workers AI embeddings with a [Cloudflare Vectorize](/docs/modules/data_connection/vectorstores/integrations/cloudflare_vectorize) vectorstore:
