...
### Using Different GitHub Instance

You may want to target a different GitHub instance than `github.com`, e.g. you have a GitHub Enterprise instance in your company.
