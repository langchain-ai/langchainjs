...
to as vector similarity-mathing or an aprximate nearest neighbor (ANN) service."
...
initial testing, you will likely want to use something like a
...
```typescript
    ...
    import { SyntheticEmbeddings } from "langchain/embeddings/fake.js";
    import { InMemoryDocstore } from "langchain/stores/doc/in_memory.js";
