...
Install the [usearch](https://github.com/unum-cloud/usearch/tree/main/javascript), which is a Node.js bindings for [USearch](https://github.com/unum-cloud/usearch).
