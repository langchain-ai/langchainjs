...
* See [here](/docs/use_cases/code/) and [here](https://twitter.com/cristobal_dev/status/1675745314592915456?s=20) for `Code`
* See [here](/docs/use_cases/tabular) for `Structured data`
...
Embed and store the splits in a vector database ([Chroma](/docs/modules/data_connection/vectorstores/integrations/chroma)).
...
* See further documentation on LLMs [here](/docs/modules/model_io/models/).
...
Using `GPT4All` is as simple as [downloading the binary]((/docs/modules/model_io/models/llms/integrations/gpt4all)) and then:
