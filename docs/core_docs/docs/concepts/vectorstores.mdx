...
We will use LangChain's [InMemoryVectorStore](https://api.js.langchain.com/classes/_langchain_core.language_models_chat_models.BaseChatModel.html) implementation to illustrate the API.
