...
**(1) Tool Creation:** Use the [@tool](https://api.js.langchain.com/functions/_langchain_core.tools.tool-1.html) decorator to create a [tool](/docs/concepts/tools). A tool is an association between a function and its schema.
