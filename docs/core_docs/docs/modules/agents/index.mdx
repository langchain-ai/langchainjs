...
- [**Toolkits**](/docs/modules/agents/tools/toolkits/): wrappers around collections of tools that can be used together a specific use case. For example, in order for an agent to
...
import Example from "@examples/agents/openai_functions.ts";
