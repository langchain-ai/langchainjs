...
This will assume knowledge of [LLMs](/docs/modules/model_io) and [retrieval](/docs/modules/retrieval) so if you haven’t already explored those sections, it is recommended you do so.
