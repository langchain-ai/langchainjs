...
from { ChatOllama } from "@langchain/community/chat_models/ollama";
...
For a deeper conceptual explanation of this difference please see [this documentation](/docs/modules/model_io/concepts)
