...
A conceptual explanation of messages, prompts, LLMs vs ChatModels, and output parsers. You should read [this section](/docs/modules/model_io/concepts) before getting started.

## [Quick Start](/docs/modules/model_io/quick_start)

Covers the basics of getting started working with different types of models. You should walk through [this section](./quick_start) if you want to get an overview of the functionality.
