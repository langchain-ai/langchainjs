...
| [SqlDatabaseChain](https://api.js.langchain.com/functions/langchain_chains_sql_db.SqlDatabaseChain.html)                    |                  | Answers questions by generating and running SQL queries for a provided database. |                                                                                                                                                                                                                                                                                                                                                                                                                      |
