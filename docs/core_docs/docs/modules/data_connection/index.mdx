...
- [Parent Document Retriever](/docs/modules/data_connection/retrievers/parent-document-retriever): This allows you to create multiple embeddings per parent document, allowing you to look up smaller chunks but return larger context.
