...
- **Reference**: Technical descriptions of the machinery and how to operate it.
  - Our [Runnable](/docs/how_to/#langchain-expression-language) pages is an example of this.
...
[LangChain Expression Language (LCEL)](/docs/how_to/#langchain-expression-language) is the fundamental way that most LangChain components fit together, and this section is designed to teach
