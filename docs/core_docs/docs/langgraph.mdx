...
It extends the [LangChain Expression Language](/docs/how_to/#langchain-expression-language-lcel) with the ability to coordinate multiple chains (or actors) across multiple steps of computation in a cyclic manner.
...
If you want to build a DAG, you should use just use [LangChain Expression Language](/docs/how_to/#langchain-expression-language-lcel).
...
Now, let's go over a more general example with a cycle. We will recreate the [`AgentExecutor`](/docs/how_to/agent_executor/) class from LangChain.
...
However, it is really easy to create your own tools - see documentation [here](/docs/how_to/custom_tools) on how to do that.
...
In LangGraph, a node can be either a function or a [runnable](/docs/how_to/#langchain-expression-language-lcel).
...
We can now use it!
This now exposes the [same interface](/docs/how_to/#langchain-expression-language-lcel) as all other LangChain runnables.
...
When should you use this versus [LangChain Expression Language](/docs/how_to/#langchain-expression-language-lcel)?
...
See the above Quick Start for an example of re-creating the LangChain [`AgentExecutor`](/docs/how_to/agent_executor/) class.
