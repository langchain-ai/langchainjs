...
import AzureOpenAI from "@examples/models/embeddings/azure_openai.ts";
...
import AzureOpenAIManagedIdentity from "@examples/models/embeddings/azure_openai-managed_identity.ts";
...
import AzureOpenAIBasePath from "@examples/models/embeddings/azure_openai-base_path.ts";
