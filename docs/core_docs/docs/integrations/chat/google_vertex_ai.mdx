...
The Gemini family of models not only support tool calling, but can also be used in the [Tool Calling agent](/docs/modules/agents/agent_types/tool_calling_agent/).
Here's an example:
