...
The Gemini family of models not only support tool calling, but can also be used in the [Tool Calling agent](/docs/modules/agents/agent_types/tool_calling/).
Here's an example:
...
:::tip
See the LangSmith trace for the agent example above [here](https://smith.langchain.com/public/021b0ae1-e295-4577-b712-78fe606f57c0/r).
:::
