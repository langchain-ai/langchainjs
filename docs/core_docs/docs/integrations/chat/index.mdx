...
| Model                   | Invoke | Stream | Batch | [Tool Calling](/docs/how_to/tool_calling/) | [`withStructuredOutput()`](/docs/how_to/structured_output/#the-.withstructuredoutput-method) | [Multimodal](/docs/how_to/multimodal_inputs/) |
| :---------------------- | :----: | :----: | :---: | :----------------------------------------: | :------------------------------------------------------------------------------------------: | --------------------------------------------- |
