...
Mistral's API now supports tool calling and JSON mode! The examples below demonstate how to use them, along with how to use the `withStructuredOutput` method to eaisly compose structured output 
