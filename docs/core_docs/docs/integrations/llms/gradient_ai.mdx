...
LangChain.js supports integration with Gradient AI. Checkout [Gradient AI](https://docs.gradient.ai/docs) for a list of available models.
...
import GradientAiExample from "@examples/llms/gradient_ai.ts";

<CodeBlock language="typescript">{GradientAiExample}</CodeBlock>
