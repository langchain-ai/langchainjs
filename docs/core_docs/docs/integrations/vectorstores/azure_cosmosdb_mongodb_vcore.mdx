...
import EnvVars from "@examples/indexes/vector_stores/azure_cosmosdb_mongodb_vcore/.env.example";
...
import Example from "@examples/indexes/vector_stores/azure_cosmosdb_mongodb_vcore/azure_cosmosdb_mongodb_vcore.ts";
