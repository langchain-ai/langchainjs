...
```bash npm2yarn
npm install cborg interface-datastore it-all datastore-core @langchain/community
```
...
import { IPFSDatastoreChatMessageHistory } from "@langchain/community/stores/message/ifps_datastore";
