...
```bash
docker run -p 8000:8000 -d --rm --name unstructured-api unstructured-api downloads.unstructured.io/unstructured-io/unstructured-api:latest --port 8000 --host 0.0.0.0
```
