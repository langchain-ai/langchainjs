...
Once you have your instance running, make sure you have the connection string. You can find them in the Azure Portal, under the "Settings / Keys" section of your instance. If you are using Managed Identity, you need to have the endpoint. Then you need to set the following environment variables:
...
import Example from "@examples/indexes/semantic_caches/azure_cosmosdb_nosql/azure_cosmosdb_nosql.ts";
