...
```typescript
import {OracleDocLoader} from "@langchain/community/document_loaders/fs/oracleai";
...
```typescript
import {OracleTextSplitter} from "@langchain/community/document_loaders/fs/oracleai";
...
```typescript
import {OracleEmbeddings} from "@langchain/community/embeddings/oracleai";
...
```typescript
import {OracleSummary} from "@langchain/community/utils/oracleai";
