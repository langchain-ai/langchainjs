...
LangChain Expression Language is a way to create arbitrary custom chains. It is built on the [`Runnable`](https://api.js.langchain.com/classes/_langchain_core.runnables.Runnable.html) protocol.
