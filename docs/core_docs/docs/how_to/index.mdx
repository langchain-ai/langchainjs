...
How to use LangChain.js with AI SDK.

- [How to: streaming agent data to the client](/docs/how_to/ai_sdk_streaming_agent)
- [How to: streaming tool responses to the client](/docs/how_to/ai_sdk_streaming_tools)
