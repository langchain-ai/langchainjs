...
This doc will break down each component into separate sections. Click [here for the server file](https://github.com/langchain-ai/langchain-nextjs-template/tree/main/app/ai_sdk/agent/action.ts)
and [here for the client file](https://github.com/langchain-ai/langchain-nextjs-template/tree/main/app/ai_sdk/agent/page.tsx) to view the complete code inside a demo application.
...
<Npm2Yarn>langchain @langchain/core @langchain/community ai</Npm2Yarn>
