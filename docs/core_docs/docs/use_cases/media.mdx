...
Google's Gemini API offers support for audio and video input.
...
Gemini did pretty well here! For music not being it's primary focus, it was able to identify a few of the instruments used in the song, and didn't helicunate any!
