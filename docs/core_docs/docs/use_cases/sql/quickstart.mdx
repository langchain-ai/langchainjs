...
<Tabs>
  <TabItem value="npm" label="npm" default>
    <CodeBlock language="bash">npm install -S langchain @langchain/community @langchain/openai</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="Yarn">
    <CodeBlock language="bash">yarn add langchain @langchain/community @langchain/openai</CodeBlock>
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock language="bash">pnpm add langchain @langchain/community @langchain/openai</CodeBlock>
  </TabItem>
</Tabs>
