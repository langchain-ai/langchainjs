...
::tip
You can see a LangSmith trace of this example [here](https://smith.langchain.com/public/6c5d5f95-7789-475f-ba99-79d5c34e593b/r).
:::
...
::tip
You can see a LangSmith trace of this example [here](https://smith.langchain.com/public/e93eff6c-6843-49e3-93bf-f1b9f5a8cafd/r).
:::

## Next steps

Under the hood, `createSqlAgentRunnable` is just passing in SQL tools to more generic agent constructors.
