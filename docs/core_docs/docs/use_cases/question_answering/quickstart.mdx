...
introduction](../../../docs/use_cases/question_answering), which has two
main components:
...
[VectorStore](../../../docs/modules/data_connection/vectorstores/) and
...
which wraps an index that can return relevant `Document`s given a string
query.
