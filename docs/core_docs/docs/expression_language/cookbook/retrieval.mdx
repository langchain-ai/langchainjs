...
<details>
  ...
  <iframe
    ...
    height="600px"
  ></iframe>
  For an interactive tutorial with an expert-led video to guide you, check out [this code-along](https://www.datacamp.com/code-along/retrieval-augmented-generation-openai-api-pinecone).
</details>
