...
<details>
  ...
  <iframe
    ...
    height="600px"
  ></iframe>
  For an interactive tutorial with an expert-led video to guide you, check out [this free code-along](https://www.datacamp.com/code-along/prompt-engineering-gpt-langchain).
</details>
