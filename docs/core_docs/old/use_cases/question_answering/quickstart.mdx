...
with
[DocumentLoaders](../../../../docs/modules/data_connection/document_loaders/). 2. **Split**: [Text
...
[Retriever](../../../../docs/modules/data_connection/retrievers/). 2.
**Generate**: A [ChatModel](../../../../docs/modules/model_io/chat) /
[LLM](../../../../docs/modules/model_io/llms) produces an answer using a
prompt that includes the question and the retrieved data
...
files](../../../../docs/modules/data_connection/document_transformers/code_splitter#markdown) -
[Code](../../../../docs/modules/data_connection/document_transformers/code_splitter)
(15+ langs) -
...
using the [Memory](../../../../docs/integrations/vectorstores/memory)
vector store and
...
text to embeddings. -
[Docs](../../../../docs/modules/data_connection/text_embedding/):
...
documentation on the interface and built-in retrieval techniques. Some
of which include: - `MultiQueryRetriever` [generates variants of the
input
...
[Docs](../../../../docs/modules/model_io/chat/): Detailed documentation
on - [Integrations](../../../../docs/integrations/chat/): 25+
integrations to choose from. -
...
- [Return
  sources](../../../../docs/use_cases/question_answering/sources):
