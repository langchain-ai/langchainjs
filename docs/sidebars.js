    ...
    "getting-started",
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "LLMs",
          link: { type: "doc", id: "modules/llms/overview" },
          items: [{ type: "autogenerated", dirName: "modules/llms" }],
        },
        {
          type: "category",
          label: "Chat",
          link: { type: "doc", id: "modules/chat_models/overview" },
          items: [{ type: "autogenerated", dirName: "modules/chat_models" }],
        },
        {
          type: "category",
          label: "Document Loaders",
          link: { type: "doc", id: "modules/document_loaders/index" },
          items: [
        ...
        },
        {
          type: "category",
          label: "Agents",
          link: { type: "doc", id: "modules/agents/overview" },
        ...
        },
        {
          type: "category",
          label: "Models (v2)",
          items: [{ type: "autogenerated", dirName: "modules/models-v2" }],
        },
      ],
    },
    "tracing",
