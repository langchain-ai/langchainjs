/**
 * createAgent + zod v4 compatibility test
 *
 * Same comprehensive test as createagent-v3 but using zod@4.x.
 * Exercises createAgent, createMiddleware, tool, toolStrategy,
 * providerStrategy with various zod schema shapes.
 *
...
console.log("createAgent + zod-v4 type check passed");
