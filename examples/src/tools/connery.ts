...
/**
 * The "getAction" method fetches the action from the Connery runner by ID, constructs a LangChain tool object from it, and returns it to the caller.
 *
...
/**
 * The "call" method of the tool takes a plain English prompt with all the information needed to run the Connery action behind the scenes.
 */
