...
const run = async () => {
  ...
  /**
   * Next, we create a vector store. This is where we store the embeddings of the documents.
   * We use the Chroma vector store here, but you can use any vector store you want.
