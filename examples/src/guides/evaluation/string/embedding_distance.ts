...
const evaluator = await loadEvaluator("embedding_distance", {distanceMetric: "euclidean"});
...
const customEmbeddingEvaluator = await loadEvaluator("embedding_distance", {embedding});
