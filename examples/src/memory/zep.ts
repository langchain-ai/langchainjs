...
export const run = async () => {
  ...
  await chatHistory.addAIChatMessage("Octavia Estelle Butler (June 22, 1947 – February "+
  "24, 2006) was an American science fiction author.");

  await chatHistory.addUserMessage("Which books of hers were made into movies?");
  await chatHistory.addAIChatMessage("The most well-known adaptation of Octavia Butler's "+
  ...
  await chatHistory.addAIChatMessage("Octavia Butler won the Hugo Award, the Nebula Award, "+
  "and the MacArthur Fellowship.");

  await chatHistory.addUserMessage("What was her most famous book?");
  await chatHistory.addAIChatMessage("Her most famous book is Kindred, which was published "+
  "in 1979.");

  await chatHistory.addUserMessage("Which other women sci-fi weiters might I want to read?");
  await chatHistory.addAIChatMessage("You might want to read Ursula K. Le Guin or Joanna Russ.");

  await chatHistory.addUserMessage("What is the Parable of the Sower about?");
  await chatHistory.addAIChatMessage("Parable of the Sower is a science fiction novel by Octavia Butler," +
  ...
  const searchResults = await chatHistory.search("Octavia Butler");
