...
import {InfoSqlTool, QuerySqlTool, SqlDatabase, ListTablesSqlTool, QueryCheckerTool} from "../tools/sql";
...
beforeEach(() => {
    ...
    db.serialize(() => {
        ...
        db.run("CREATE TABLE products (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, price INTEGER)");
