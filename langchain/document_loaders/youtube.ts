...
export class YouTubeLoader extends BaseDocumentLoader {
  ...
  public static fromYoutubeUrl(youtubeUrl: string, addVideoInfo = false): YouTubeLoader {
  ...
  public async load(): Promise<Document[]> {
    ...
    const transcriptPieces = await YouTubeTranscript.fetchTranscript(this.videoId);
