...
export class GraphCypherQAChain {
  ...
  static fromLLM(props: {
    ...
    qaPrompt?: any; //  BasePromptTemplate;
    cypherPrompt?: any; //  BasePromptTemplate;
    cypherLLM?: any; // BaseLanguageModel | null;
    qaLLM?: any; //  BaseLanguageModel | null;
  }) {
    // const {
    //   // graph,
