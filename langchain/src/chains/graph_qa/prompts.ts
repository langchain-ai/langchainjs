...
const _DEFAULT_GRAPH_QA_TEMPLATE = `Use the following knowledge triplets to answer the question at the end. If you don't know the answer, just say that you don't know, don't try to make up an answer.

{context}

Question: {question}
Helpful Answer:`;
export const GRAPH_QA_PROMPT = new PromptTemplate({
  template: _DEFAULT_GRAPH_QA_TEMPLATE,
