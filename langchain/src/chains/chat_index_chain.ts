...
export interface ChatIndexQAChainInput {
  index: BaseIndex;
...
export class ChatIndexQAChain
  extends BaseChain
  implements ChatIndexQAChainInput {
  ...
  async _call(values: ChainValues): Promise<ChainValues> {
    ...
    const docs = await this.index.getRelevantTexts(newQuestion);
    const inputs = {
