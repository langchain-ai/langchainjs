...
const question_generator_template = `Given the following conversation and a follow up question, rephrase the follow up question to be a standalone question using the language addressed in by the user.
...
const qa_template = `Chat History:
{chat_history}

Use the chat history above and the following pieces of additional context knowledge to answer the question at the end in the language addressed in by the user. If you don't know the answer, just say that you don't know, don't try to make up an answer.
