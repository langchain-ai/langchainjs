 ...
 *
 * @export
 * @interface CompletionResponseChoices
 */
export interface CompletionResponseChoices {
  /**
   *
   * @type {string}
   * @memberof CompletionResponseChoices
   */
...
interface ChatCompletionResponse {
  ...
  usage: TokenUsage;
  base_resp: BaseResp;
  choices: Array<CompletionResponseChoices>;
}
