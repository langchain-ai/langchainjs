 ...
 */
export class FalkorDBGraphStore extends GraphStore {
  ...
  static fromTexts(
    ...
    return FalkorDBGraphStore.fromDocuments(docs, embeddings, dbConfig);
  }

  /**
   * Static method for creating a new instance of FalkorDBGraphStore from
   * documents. It adds the documents to the FalkorDBGraphStore.
   * @param docs The documents to add.
   * @param embeddings The embeddings to use.
   * @param dbConfig The configuration for the FalkorDBGraphStore.
   * @returns A promise that resolves to a new instance of FalkorDBGraphStore.
   */
  ...
  /**
   * Method for checking if an index exists in the FalkorDBGraphStore.
